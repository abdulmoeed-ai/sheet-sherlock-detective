  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 px-5 pt-5 pb-4">
        <div className="flex h-8 w-8 items-center justify-center rounded-md" style={{ background: "var(--color-accent-sparkle)" }}>
      ...
      <div className="px-3 pb-2 pt-1">
        <div
          ...
          style={{ background: "rgba(255,255,255,0.04)", color: "var(--color-sidebar-text)" }}
        >
      ...
      <div className="mt-3 px-4 pb-1 text-[10px] font-semibold uppercase tracking-[0.08em]" style={{ color: "#5C7A68" }}>
        Workspace
      </div>
          ...
          return (
            ...
            >
              <Icon
                ...
                style={{ color: active ? "#FFFFFF" : "var(--color-sidebar-icon)" }}
              />
      ...
      <div className="mx-3 mb-4 rounded-lg p-3" style={{ background: "var(--color-sidebar-active)" }}>
        <div className="flex items-center gap-2">
          <Sparkles className="h-4 w-4" style={{ color: "var(--color-accent-mid)" }} />
