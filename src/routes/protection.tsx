...
const TIER_META: Record<
  Tier,
  { label: string; tone: "danger" | "warning" | "neutral" | "success" }
> = {
...
const INITIAL: Rule[] = [
  {
    id: "r1",
    scope: "IS!D4:D40",
    description: "Income statement P&L formula spine",
    tier: "core-formula",
    status: "locked",
    approver: "CFO",
  ...
  },
  {
    id: "r2",
    scope: "BS!E4:E60",
    description: "Balance sheet roll-forward links",
    tier: "linking",
    status: "locked",
    approver: "Manager",
    lastChange: "2026-05-12",
  },
  {
    id: "r3",
    scope: "CF!D4:D45",
    description: "Indirect cash flow build",
    tier: "core-formula",
    status: "locked",
    approver: "CFO",
    lastChange: "2026-05-12",
  },
  {
    id: "r4",
    scope: "Assump!C8:C40",
    description: "Macro + sector assumption block",
    tier: "assumption",
    status: "open",
    approver: "Analyst",
  ...
  {
    id: "r5",
    scope: "Forecast!E5:J35",
    description: "5-year forecast driver cells",
    tier: "assumption",
    status: "open",
    approver: "Analyst",
    lastChange: "2026-05-19",
  },
  {
    id: "r6",
    scope: "KPI!B2:B12",
    description: "Executive KPI dashboard outputs",
    tier: "output",
    status: "locked",
    approver: "Manager",
    lastChange: "2026-05-12",
  },
  {
    id: "r7",
    scope: "IS!D27",
    description: "Tax rate override (FY25 one-off)",
    tier: "core-formula",
    status: "override",
    approver: "CFO",
    lastChange: "2026-05-19",
    ...
    setRules((rs) =>
      rs.map((r) =>
        r.id === id
          ? {
              ...r,
              status: r.status === "locked" ? "open" : "locked",
    ...
    >
      ...
      >
        ...
        <div className="text-[13px] font-semibold" style={{ color: "var(--color-success-fg)" }}>
          {locked} of {rules.length} protection rules active · {overrides} approved override(s) on
          this version.
        </div>
      </div>
