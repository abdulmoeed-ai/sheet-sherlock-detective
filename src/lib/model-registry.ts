...
const seed: ModelVersion[] = [
  {
    ...
    status: "draft",
    completeness: 62,
    lastEditedBy: "Ayesha S.",
    lastEditedAt: "2026-05-19 16:04",
  },
  {
    id: "MTL_FY2024_v3",
    ticker: "MTL",
    ...
    status: "approved",
    completeness: 100,
    lastEditedBy: "Bilal R. (CFO)",
    lastEditedAt: "2025-09-12 11:21",
  },
  {
    id: "MTL_FY2024_v2",
    ticker: "MTL",
...
export function statusTone(s: RegistryStatus): "neutral" | "warning" | "success" | "info" {
  return s === "approved" || s === "locked" ? "success" : s === "in-review" ? "warning" : "info";
}
